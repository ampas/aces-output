// <ACEStransformID>urn:ampas:aces:transformID:v2.0:InvOutput.Academy.Rec2020-D60_500nit_in_Rec2020-D65_ST2084.a2.v1</ACEStransformID>
// <ACESuserName>Inverse Rec.2020 ST2084 (500 nit) (D60 simulation)</ACESuserName>
...
const Chromaticities encodingPri = // Rec.2020 Primaries / ACES "~D60" White
    {
        {0.7080,  0.2920},
        {0.1700,  0.7970},
        {0.1310,  0.0460},
...
const float peakLuminance = 500.; // luminance the tone scale highlight rolloff will target in cd/m^2 (nits)
